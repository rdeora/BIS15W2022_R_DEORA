...
mammals %>% 
  ...
  mutate(newborn_new = ifelse(max_life == -999.00, NA, max_life))%>% 
  arrange(max_life)
```

```
## # A tibble: 1,440 × 4
##    genus       species     max_life newborn_new
##    <chr>       <chr>          <dbl>       <dbl>
##  1 Ammodorcas  clarkei         -999          NA
##  2 Capra       caucasica       -999          NA
##  3 Capra       ibex            -999          NA
##  4 Cephalophus niger           -999          NA
##  5 Cephalophus natalensis      -999          NA
##  6 Cephalophus leucogaster     -999          NA
##  7 Cephalophus ogilbyi         -999          NA
##  8 Cephalophus zebra           -999          NA
##  9 Cephalophus rufilatus       -999          NA
## 10 Cephalophus dorsalis        -999          NA
## # … with 1,430 more rows
```
```
