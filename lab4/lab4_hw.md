...
## # … with 559 more rows, and 2 more variables: log10.preymass <dbl>, PPMR <dbl>
```
...
##    <chr>         <chr>                   <chr>      
##  1 lake fishes   american eel            rostrata   
##  2 river fishes  blacktail redhorse      poecilura  
##  3 river fishes  central stoneroller     anomalum   
##  4 river fishes  rosyside dace           funduloides
##  5 river fishes  longnose dace           cataractae 
##  6 river fishes  muskellunge             masquinongy
##  7 marine fishes pollack                 pollachius 
##  8 marine fishes saithe                  virens     
##  9 marine fishes lined surgeonfish       lineatus   
## 10 marine fishes orangespine unicornfish lituratus  
## # … with 559 more rows
```
